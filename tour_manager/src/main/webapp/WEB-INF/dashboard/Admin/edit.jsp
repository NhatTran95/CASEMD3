    ...
    <div class="col-6 mt-5 ">
        <form method="post">
            ...
            <div class="row mt-3 mb-3">
                ...
                <div class="col-9">
                    <input type="text" class="form-control" name = "username" value="${sessionScope.user.getUsername()}" readonly/>
...
<%--                    <input type="text" class="form-control" name = "fullname" value="${requestScope.user.getFullname()}"/>--%>
            ...
            <div class="row mb-3">
                ...
                <div class="col-9">
                    <input type="text" class="form-control" name="email" value="${sessionScope.user.getEmail()}"/>
<%--                    <input type="text" class="form-control" name="email" value="${requestScope.user.getEmail()}"/>--%>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-9">
                    <input type="text" class="form-control" name="phone" value="${sessionScope.user.getPhone()}"/>
<%--                    <input type="text" class="form-control" name="phone" value="${requestScope.user.getPhone()}"/>--%>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-9 offset-3">
                    <button class="btn btn-primary">Save</button>
                    <a href="/admin"><button type="button" class="btn btn-dark">Cancel</button></a>
                </div>
            </div>
        </form>
    </div>
